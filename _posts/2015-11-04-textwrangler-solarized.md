...
---
I have been using [Textwrangler](http://www.barebones.com/products/textwrangler/) for years as my go-to text editor. There are many features of Textwrangler that I like, so I decided to stick with it as my primary text editor, but customize it a bit by installing one of the low contrast themes.
